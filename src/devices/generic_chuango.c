...
static int generic_chuango_callback(bitbuffer_t *bitbuffer) {
	...
	if ((bits == 25)
	 ...
	 && (b[0] != 0x00) && (b[1] != 0x00) && (b[2] != 0x00)	// Reduce false positives. ID 0x00000 not supported
		...
		fprintf(stdout, "Chuango Security Technology (generic EV1527)\n");
...
PWM_Precise_Parameters pwm_precise_parameters_generic_chuango = {
	.pulse_tolerance	= 50,
	.pulse_sync_width	= 0,	// No sync bit used
};

r_device generic_chuango = {
	.name			= "Generic EV1527 as sometimes used by Chuango Security Technology",
	.modulation		= OOK_PULSE_PWM_PRECISE,
	.short_limit	= 116,	// Pulse: Short 142, Long 426 
	.long_limit		= 351,	// Gaps:  Short 142, Long 424
	.reset_limit	= 450,	// Intermessage Gap 4300 (individually for now)
	.json_callback	= &generic_chuango_callback,
	.disabled		= 0,
	.demod_arg		= (unsigned long)&pwm_precise_parameters_generic_chuango,
};
